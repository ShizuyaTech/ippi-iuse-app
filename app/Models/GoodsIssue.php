...
{
    protected $fillable = ['gi_number', 'reference_type', 'reference_id', 'issue_date', 'issue_type', 'destination_name', 'destination_storage_location_id', 'storage_location_id', 'status', 'notes', 'created_by'];
