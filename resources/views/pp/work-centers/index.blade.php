        ...
        <table class="w-full text-sm border-collapse">
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50">
                    <td class="px-4 py-2 font-mono text-blue-700 font-medium">{{ $wc->code }}</td>
                    <td class="px-4 py-2">{{ $wc->name }}</td>
                    <td class="px-4 py-2">{{ $wc->capacity_per_hour ?? '-' }}</td>
                    <td class="px-4 py-2">{{ $wc->cost_per_hour ? number_format($wc->cost_per_hour, 0) : '-' }}</td>
