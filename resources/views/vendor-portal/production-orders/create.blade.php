    ...
    <div class="max-w-3xl bg-white rounded-lg shadow p-6" x-data="{ selectedPoItemId: '' }">
        ...
        <form method="POST" action="{{ route('vendor.production-orders.store') }}" class="space-y-4">
            ...
            <div>
                ...
                <select name="purchase_order_item_id" x-model="selectedPoItemId" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm" required>
            ...
            <div class="grid grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="number" name="quantity_planned" step="0.001" min="0.001" value="{{ old('quantity_planned') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm" required>
                ...
                <div>
                    ...
                    <input type="date" name="planned_start_date" value="{{ old('planned_start_date') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Planned End</label>
                    <input type="date" name="planned_end_date" value="{{ old('planned_end_date') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm">
                </div>
            </div>
