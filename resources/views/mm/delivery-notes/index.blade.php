<x-app-layout>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <form method="GET" class="flex flex-wrap gap-2 mb-4">
            ...
            <select name="source_type" class="border border-gray-300 rounded-lg px-3 py-2 text-sm">
            ...
            <select name="gr_status" class="border border-gray-300 rounded-lg px-3 py-2 text-sm">
        ...
        <table class="w-full text-sm border-collapse">
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50">
                    <td class="px-4 py-2 font-mono text-blue-700" data-label="No. SJ">
                        {{ $dn->dn_number }}
                    ...
                    <td class="px-4 py-2" data-label="Vendor">{{ $dn->vendor?->name ?? '-' }}</td>
                    <td class="px-4 py-2 font-mono text-xs text-gray-600" data-label="No. PO">{{ $dn->purchaseOrder?->po_number ?? '-' }}</td>
                    <td class="px-4 py-2" data-label="Est. Pengiriman">{{ $dn->estimated_delivery_date?->format('d/m/Y') ?? '-' }}</td>
                    <td class="px-4 py-2 text-center text-gray-500" data-label="Item">{{ $dn->items_count }} item</td>
                    ...
                    <td class="px-4 py-2 text-center" data-label="GR">
                        @if($dn->goodsReceipt)
