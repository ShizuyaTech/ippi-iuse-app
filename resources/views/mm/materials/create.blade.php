        ...
        <form method="POST" action="{{ route('mm.materials.store') }}" class="space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="unit_of_measure" value="{{ old('unit_of_measure', 'PCS') }}" class="w-full border rounded px-3 py-2 text-sm" required>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Harga Standard *</label>
                    <input type="number" name="standard_price" value="{{ old('standard_price', 0) }}" step="0.01" min="0" class="w-full border rounded px-3 py-2 text-sm" required>
                </div>
            </div>
            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Qty per Case / Karton</label>
                    <input type="number" name="qty_per_case" value="{{ old('qty_per_case', 0) }}" step="0.001" min="0" class="w-full border rounded px-3 py-2 text-sm">
                ...
                <div>
                    ...
                    <input type="number" name="min_stock" value="{{ old('min_stock', 0) }}" step="0.001" min="0" class="w-full border rounded px-3 py-2 text-sm">
            ...
            <div class="border rounded p-4 bg-gray-50 space-y-3">
                ...
                <div>
                    ...
                    <div id="process_vendor_field" class="{{ old('process_vendor_id') ? '' : 'hidden' }}">
                        <select name="process_vendor_id" id="process_vendor_select" class="w-full border rounded px-3 py-2 text-sm">
